...
auto DimensionLabel(MazeGeneration::MazeAlgorithmType /*type*/) -> const char* {
  return "2D";
}
...
void PrintSupportedGenerationAlgorithms(std::ostream& out) {
  ...
  const std::vector<MazeGeneration::MazeAlgorithmType> algorithms = {
      MazeGeneration::MazeAlgorithmType::DFS,
      MazeGeneration::MazeAlgorithmType::PRIMS,
      MazeGeneration::MazeAlgorithmType::KRUSKAL,
      MazeGeneration::MazeAlgorithmType::RECURSIVE_DIVISION,
      MazeGeneration::MazeAlgorithmType::GROWING_TREE};
  for (const auto algorithm : algorithms) {
    out << "  - " << MazeGeneration::algorithm_name(algorithm) << " ["
